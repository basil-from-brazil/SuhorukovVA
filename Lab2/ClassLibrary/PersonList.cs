...
namespace ClassLibrary
{
    ...
    public class PersonList
    {
        ...
        public void AddPerson(PersonBase person)
        {
            ...
            _people = new PersonBase[currentPeople.Length + 1];
        ...
        public void AddSeveralPeople(PersonBase[] people)
        {
        ...
        public PersonBase GetPersonByIndex(int indexOfPerson)
        {
